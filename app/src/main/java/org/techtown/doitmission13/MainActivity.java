...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText2 = editText2.findViewById(R.id.editText2);
        editText3 = editText3.findViewById(R.id.editText3);
        ...
        adapter.addItem(new Customer("김준수", "1995-10-12", "010-4433-9964", R.drawable.customer));
        adapter.addItem(new Customer("이희연", "1995-10-12", "010-4433-9964", R.drawable.customer));
        ...
        @Override
            ...
            Toast.makeText(getApplicationContext(),"아이템 선택함"+ item.getName(), Toast.LENGTH_LONG).show();
        }
    });
